...
def test_withdrawal_ui_and_persistence_contract_present():
    ...
    assert 'MarketScope Portfolio Split Simulator v20 - v5.9.61 160K annual-withdrawal Top100 + UI visibility/logo restore + dynamic annual history + required instrument market data on page 1' in APP
