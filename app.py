...
with st.sidebar:
    ...
    st.caption("Fast startup uses the last durable snapshot. v5.3 limits the Nasdaq stock universe to market cap strictly above $100B while retaining the requested ETFs and manually persisted symbols. The full scheduled refresh runs every day at 6:00 PM America/New_York.")
...
if refresh_now:
    ...
    # This is the v5.3 safeguard that keeps returns visible even if Render's IP
    ...
    # Stage 1: historical adjusted data supplies 10Y, 5Y, 1Y, YTD, 6M, 3M, 1M and 1D.
    history_success = 0
    processed = 0
