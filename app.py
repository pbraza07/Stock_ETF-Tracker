...
with save_cols[3]:
    if portfolio_save_ready:
        st.caption("The saved record preserves the exact allocation, period, return results and PDF layout shown in your simulation.")
    else:
...
if save_simulation_clicked and portfolio_save_ready:
    ...
    record = {
        ...
        "pdf_layout": "MarketScope Portfolio Split Simulator v2 - analytics + timeframe performance",
    }
    ...
    for r0 in range(0, len(rows), 3):
        ...
        for c, (_, row) in zip(cols, rows[r0:r0+3]):
            ...
            with c:
                ...
                action_cols = st.columns(3 if is_etf else 2)
                with action_cols[0]:
