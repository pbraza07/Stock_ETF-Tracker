...
def _card_display_name(row: pd.Series) -> str:
    """Use ETF Sector as the card's descriptive name; stocks keep company name."""
...
if selected and selected in set(market["Symbol"].astype(str)):
    ...
    st.markdown("#### Year-by-year price chart")
...
- **Year chart:** opening a card lets you choose the current year or any of the prior 10 calendar years. The plotted adjusted daily closes and the chart summary update to the selected year only.
