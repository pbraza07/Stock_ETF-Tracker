...
def test_withdrawal_ui_and_persistence_contract_present():
    ...
    assert 'MarketScope Portfolio Split Simulator v21 - v5.9.62 responsive yearly-withdrawal + compact simulator KPI layout + dynamic annual history + required instrument market data on page 1' in APP
