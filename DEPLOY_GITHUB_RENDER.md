...
## v5.9.18 universe status

The scheduled 6:00 PM ET workflow now writes and commits `data/universe_metadata.json`. This file drives the app labels **Nasdaq Universe Last Refreshed** and **Stocks Added / Removed Today**. Run the workflow once after upgrading so these fields become live immediately.
