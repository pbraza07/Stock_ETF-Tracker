...
styled = (
    ...
    .set_properties(**{"font-size": "17px", "font-weight": "500"})
    .set_properties(subset=["Symbol"], **{"font-size": "18px", "font-weight": "700"})
)
st.dataframe(
    styled,
    width="stretch",
...
- **Returns:** Yahoo/yfinance adjusted daily market history. 1Y/3Y/5Y/10Y Avg are annualized CAGR; YTD/6M/3M/1M/1D are point-to-point adjusted total returns. Stocks do not have NAV; ETF NAV is displayed separately when available.
