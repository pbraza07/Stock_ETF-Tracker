...
def test_workflow_runs_dynamic_history_before_rankings():
    ...
    assert 'name: Refresh MarketScope universe, snapshot and actual monthly rankings (v5.9.79)' in WORKFLOW
