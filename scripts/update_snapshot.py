...
def main() -> None:
    ...
    # Keep only explicitly manual additions outside the automatic Nasdaq >$100B
    # universe. This prevents older v5.2 >$100M automatic rows from surviving
    # forever as "extras" after the v5.3 universe threshold is raised.
