...
## v5.9.18 - universe audit + 1D defaults + PDF analyst snapshot

- 1D high-to-low is the default ranking in Card and Table views.
- Portfolio Split Simulator starts at $100,000.
- The app displays the last Nasdaq >$100B universe refresh plus stocks added/removed in that refresh.
- Portfolio PDF page 1 includes instrument name, sector, analyst rating, and low/average/high price targets.
- The v5.9.7-style clickable return-card profit workflow is preserved.
